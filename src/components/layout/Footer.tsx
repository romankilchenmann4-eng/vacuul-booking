import { SITE_NAME, SITE_URL, INSTAGRAM_URL, NAV_LINKS } from "@/lib/constants";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm hover:text-vacuul-accent transition-colors"
            >
